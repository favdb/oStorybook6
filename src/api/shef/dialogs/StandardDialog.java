...
public class StandardDialog extends JDialog {
	...
	private void init(int orientation, int spacing) {
		...
		Action cancelAction = new AbstractAction(I18N.getMsg("shef.cancel")) {
	 ...
	 *
	 * @returns a boolean indicating if the data is valid. <code>true</code> indicates that all of the fields were
