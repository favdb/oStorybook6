...
import api.infonode.docking.properties.ViewTitleBarProperties;
import api.infonode.docking.properties.WindowBarProperties;
import api.infonode.docking.theme.internal.laftheme.TitleBarUI;
import api.infonode.docking.theme.internal.laftheme.TitleBarUIListener;
import api.infonode.gui.InsetsUtil;
import api.infonode.gui.colorprovider.BackgroundColorProvider;
import api.infonode.gui.componentpainter.ComponentPainter;
import api.infonode.gui.componentpainter.CompoundComponentPainter;
...
import api.infonode.tabbedpanel.theme.LookAndFeelTheme;
import api.infonode.tabbedpanel.titledtab.TitledTabSizePolicy;
 ...
 * @see api.infonode.tabbedpanel.theme.LookAndFeelTheme
 * @since IDW 1.4.0
 */
