...
/**
 * A map of views that handles view serialization by assigning an integer id to each view. The id is
 * unique for each view in the map. To guarantee serialization compatibility a view id must remain
 * constant.
 *
...
public class ViewMap extends AbstractViewMap {
	...
	/**
	 * Utility constructor that creates a map with a number of views. A view gets it's index in the
	 * array as id.
	 *
