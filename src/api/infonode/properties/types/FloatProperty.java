...
public class FloatProperty extends ValueHandlerProperty {
	 ...
	 * @param minValue the smallest value that this property can have
	 * @param maxValue the largest value that this property can have
	 * @param preferredDigitCount the preferred number of digits to allocate space for in an editor
	...
	/**
	 * Returns the preferred number of digits to allocate space for in an editor for a property
	 * value.
	 *
	 * @return the preferred number of digits to allocate space for in an editor for a property
	 * value
	 */
