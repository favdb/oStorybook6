...
import api.infonode.gui.DynamicUIManager;
import api.infonode.gui.DynamicUIManagerListener;
import api.infonode.gui.border.HighlightBorder;
import api.infonode.gui.hover.HoverListener;
import api.infonode.gui.icon.button.ArrowIcon;
import api.infonode.gui.icon.button.BorderIcon;
import api.infonode.gui.icon.button.DropDownIcon;
import api.infonode.properties.base.Property;
import api.infonode.properties.gui.util.ButtonProperties;
import api.infonode.properties.propertymap.*;
import api.infonode.properties.types.*;
import api.infonode.tabbedpanel.border.OpenContentBorder;
...
public class TabbedPanelProperties extends PropertyMapContainer {
   ...
   * the {@link api.infonode.gui.icon.IconProvider} and the text will be retrieved by calling
   * toString() on the tab.
   * </p>
   *
