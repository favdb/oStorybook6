...
public class ComponentUtil {
	...
	public static void getComponentTreePosition(Component c, ArrayList pos) {
		...
		pos.add(c.getParent().getComponentCount() - ComponentUtil.getComponentIndex(c));
	}
	 ...
	 * {@link Component#requestFocusInWindow()}when the component is focus owner changes focus owner
	 ...
	 *
	 * @param component the component to request focus for
	 * @return the component which has focus or probably will obtain focus, null if no component
	 * will receive focus
	 */
