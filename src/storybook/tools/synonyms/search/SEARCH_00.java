 ...
 *
 * synonyms: base url for searching synonyms
 *
 * antonyms: base url for searching antonyms
 *
 * @author favdb
 */
public class SEARCH_00 extends SEARCH_Abstract {
	...
	public static final String URL_SYNONYMS_PROMPT = "website name for synonyms",
			URL_SYNONYMS = "base URL for synonyms",
			URL_ANTONYMS_PROMPT = "website name for antonyms",
			URL_ANTONYMS = "base URL for antonyms";

	public SEARCH_00(String word) {
		super(word);
	}
	...
	public List<String> synonyms() {
		...
		if (inHtml != null && !inHtml.isEmpty()
				&& inHtml.contains("article class=\"synonym\"")) {// content to check
			//extract synonyms
		}
		return words;
	}
	...
	public List<String> antonyms() {
		...
		if (inHtml != null && !inHtml.isEmpty()
				&& inHtml.contains("article class=\"antonym\"")) {// content to check
			//extract antonyms
		}
		return words;
	}
