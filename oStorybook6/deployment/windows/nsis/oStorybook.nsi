...
!define DESCRIPTION "${VERSIONMAJOR}"
!define DISTDIR "..\..\..\dist"
# These will be displayed by the "Click here for support information" link in "Add/Remove Programs"
# It is possible to use "mailto:" links in here to open the email client
!define HELPURL "http://ostorybook.tuxfamily.org/v5" # "Support Information" link
!define UPDATEURL "http://download.tuxfamily.org/ostorybook/" # "Product Updates" link
!define ABOUTURL "http://ostorybook.eu/" # "Publisher" link
# This is the size (in kB) of all the files copied into "Program Files"
!define INSTALLSIZE 2200
