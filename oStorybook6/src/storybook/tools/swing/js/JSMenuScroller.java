...
/**
 * @(#)MenuScroller.java	1.5.0 04/02/12 from
...
public class JSMenuScroller {
	 ...
	 */
	public static JSMenuScroller setScrollerFor(JMenu menu) {
		return new JSMenuScroller(menu);
	}
	 ...
	 * @return the MenuScroller
	 */
	public static JSMenuScroller setScrollerFor(JPopupMenu menu) {
		return new JSMenuScroller(menu);
	}
	 ...
	 */
	public static JSMenuScroller setScrollerFor(JMenu menu, int scrollCount) {
		return new JSMenuScroller(menu, scrollCount);
	}
	 ...
	 * @throws IllegalArgumentException if scrollCount is 0 or negative
	 */
	public static JSMenuScroller setScrollerFor(JPopupMenu menu, int scrollCount) {
		return new JSMenuScroller(menu, scrollCount);
	}
	 ...
	 */
	public static JSMenuScroller setScrollerFor(JMenu menu, int scrollCount, int interval) {
		return new JSMenuScroller(menu, scrollCount, interval);
	}
	 ...
	 * @throws IllegalArgumentException if scrollCount or interval is 0 or negative
	 */
	public static JSMenuScroller setScrollerFor(JPopupMenu menu, int scrollCount, int interval) {
		return new JSMenuScroller(menu, scrollCount, interval);
	}
	 ...
	 * @param menu the menu
	 */
	public JSMenuScroller(JMenu menu) {
		this(menu, 15);
		this.jmenu = menu;
	}
	 ...
	 * @param menu the popup menu
	 */
	public JSMenuScroller(JPopupMenu menu) {
		this(menu, 15);
	}
	 ...
	 * @throws IllegalArgumentException if scrollCount is 0 or negative
	 */
	public JSMenuScroller(JMenu menu, int scrollCount) {
	 ...
	 * @throws IllegalArgumentException if scrollCount is 0 or negative
	 */
	public JSMenuScroller(JPopupMenu menu, int scrollCount) {
		this(menu, scrollCount, 150);
	}
	 ...
	 * @throws IllegalArgumentException if scrollCount or interval is 0 or negative
	 */
	public JSMenuScroller(JMenu menu, int scrollCount, int interval) {
	 ...
	 * @throws IllegalArgumentException if scrollCount or interval is 0 or negative
	 */
	public JSMenuScroller(JPopupMenu menu, int scrollCount, int interval) {
		this(menu, scrollCount, interval, 0, 0);
	}
