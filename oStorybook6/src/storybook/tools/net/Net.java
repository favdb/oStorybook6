...
public class Net {
	...
	public enum KEY {
		...
		DOC("http://ostorybook.free.fr/doc/fr/"),
		FAQ("https://ostorybook.eu/v6/fr/oStorybook-P1C07S009.html"),
		DOWNLOAD("http://ostorybook.free.fr/" + "download/"),
		DOWNLOAD_CURRENT(DOWNLOAD + "current/"),
		VERSIONS(DOWNLOAD_CURRENT + "Versions.txt"),
