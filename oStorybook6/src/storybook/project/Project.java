...
public class Project {
	...
	public boolean save(File outfile) {
		//LOG.printInfos(TT + "write(file=" + (file==null?"null":file.getAbsolutePath()) + ")");
		if (outfile == null) {
			return false;
		}
	...
	public void write(AbstractEntity entity) {
		//LOG.printInfos(TT + "write(entity=" + LOG.printInfos(entity) + ")");
	...
	public void doBackup(String backupFilename, boolean increment) {
		//todo
	}
