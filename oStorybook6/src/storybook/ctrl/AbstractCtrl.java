...
public abstract class AbstractCtrl implements PropertyChangeListener {
	...
	public void attachModel(AbstractModel model) {
		//LOG.trace(TT+"attachModel(" + model.toString() + ")");
	...
	public void detachModel(AbstractModel model) {
		//LOG.trace(TT+"detachModel(" + model.toString() + ")");
	...
	public void printNumberOfAttachedViews() {
		...
		System.out.println(" attached views size: " + attachedViews.size());
	}

	public void printAttachedViews() {
		//LOG.trace(TT+"printAttachedViews()");
		for (Component comp : attachedViews) {
			System.out.println((comp.getName() != null ? comp.getName() : "unknown comp name"));
		}
	}

	/**
	 * get informations of the attached views
	 *
	 * @param html true for HTML rendering
	 *
	 * @return
	 */
	...
	/**
	 * print trace of the attached models, for debugging purpose
	 */
	public void printAttachedModels() {
		//LOG.trace(TT+"printAttachedModels()");
	}
	...
	/**
	 * generic setModelProperty
	 *
	 * @param type Book.TYPE of the element
	 * @param cmd Ctrl.PROPS type for command
	 * @param value entity
	 */
	...
	/**
	 * set the model property for the given name and the given object
	 *
	 * @param propName
	 * @param newValue
	 */
				...
				try {
					switch (Ctrl.getPROPS(propName)) {
						...
						case MANAGE_COLUMNS:
							...
							return;
						case MANAGE_ZOOM:
							bookModel.ManageWidth((Integer) newValue);
							return;
	...
	/**
	 * set the model property for the given name
	 *
	 * @param propertyName
	 */
	...
	/**
	 * get the number of the attached views
	 *
	 * @return
	 */
	...
	/**
	 * get the list of the attached views
	 *
	 * @return
	 */
	...
	/**
	 * get the list of attached models
	 *
	 * @return
	 */
