...
public class Model extends AbstractModel {
	...
	public void fireAgain(SbView view) {
		//LOG.printInfos(TT + ".fireAgain(" + view.getName() + ")");
	...
	public synchronized void ENTITY_Update(AbstractEntity entity) {
		//LOG.printInfos(TT + ".ENTITY_Update(entity=" + entity.toString() + ")");
		entity.setMaj();
	...
	public synchronized void EPISODE_Delete(Episode entity) {
		//LOG.printInfos(TT + ".setEpisodeDelete(entity=" + App.traceEntity(entity) + ")");
		if (entity.getId() == null) {
			return;
		}
