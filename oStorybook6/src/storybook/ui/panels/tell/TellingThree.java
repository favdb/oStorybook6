 ...
 * @author favdb
 */
public class TellingThree extends TellingAbstract {
    ...
    public TellingThree(TellingPanel panel) {
	super(panel);
    }
	...
	//LOG.trace(TT + "drawStories() nb stories=" + stories.size());
	int n = 0, prev = 0;
	...
	//LOG.trace(TT+"drawStory(fr=" + fr.getName() + ", n=" + n + ") value=" + fr.getValue());
	...
	for (int i = 0; i < points.size() - 2; i++) {
	    ...
	    Draw.arrow2(g, p1, p2, Color.ORANGE, 3);
	}
    }
