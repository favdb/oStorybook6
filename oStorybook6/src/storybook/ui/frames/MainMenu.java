...
public class MainMenu implements MouseListener {
	...
	private void initUi() {
		initToolbar();
		menuFileInit();
		menuBar.add(menuEdit = menuEditInit());
		menuNewInit();
		menuTableInit();
		menuToolsInit();
		menuViewInit();
	 ...
	 */
	private JMenu menuEditInit() {
		//LOG.trace(TT+"initMenuEdit()");
		JMenu m = initMenu("edit");
	...
	/**
	 * get JMenuBar for Scriber mode
	 *
	 * @return the generated JMenuBar
	 */
	public JMenuBar getMenuForScriber() {
		JMenuBar m = new JMenuBar();

		m.add(menuFile);
		JMenu edit = initMenu("edit");
		m.add(initMenuItem(K.PREFERENCES, "preferences.title", "",
				evt -> PreferencesDlg.show(mainFrame)));
		m.add(edit);
	...
	/**
	 * get an hiden menu usable for entity editor
	 *
	 * @param comp
	 * @return
	 */
