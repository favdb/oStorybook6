...
public class SbViewFactory {
	...
	public boolean loadView(SbView view) {
		...
		switch (SbView.getVIEW(view)) {
			...
			/*case NAVIGATION:
				...
				break;*/
			case PLANNING:
				comp = new PlanningPanel(mainFrame);
				break;
			case READING:
			...
			case TIMELINE:
				...
				break;
			case STORY_THREE:
				comp = new TellingPanel(mainFrame, TellingPanel.TELLTYPE.THREE);
				break;
			case STORY_FREYTAG:
				comp = new TellingPanel(mainFrame, TellingPanel.TELLTYPE.FREYTAG);
				break;
			case STORY_VOGLER:
				comp = new TellingPanel(mainFrame, TellingPanel.TELLTYPE.VOGLER);
				break;
			case TREE:
	...
	public SbView getPlanView() {
		...
		return (SbView) viewMap.getView(VIEWNAME.PLANNING.toString());
	}
	...
	public SbView getClassicView() {
		...
		return (SbView) viewMap.getView(VIEWNAME.STORY_THREE.toString());
	}
	...
	public SbView getFreytagView() {
		...
		return (SbView) viewMap.getView(VIEWNAME.STORY_FREYTAG.toString());
	}
	...
	public SbView getVoglerView() {
		...
		return (SbView) viewMap.getView(VIEWNAME.STORY_VOGLER.toString());
	}
