...
public abstract class AbstractExport {
	...
	public boolean writeHeaderHtml() {
		...
		b.append("<meta name=\"description\" content=\"generated by ")
				.append(Const.getFullName())
				.append("\" />\n");
	...
	public void writeText(String str) {
		//LOG.trace(TT + "writeText(str len=" + str.length() + ")");
		if (!isOpened) {
			return;
		}
		if ("".equals(str)) {
	...
	public void closeFile(boolean verbose) {
		...
		try {
			IOUtil.fileWriteString(outFile, outBuffer.toString());
			//outStream.close();
			isOpened = false;
			if (verbose) {
				JOptionPane.showMessageDialog(mainFrame,
