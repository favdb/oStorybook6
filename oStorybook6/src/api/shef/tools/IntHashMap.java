...
/**
 * <p>
 * A hash map that uses primitive ints for the key rather than objects.</p>
 *
 * <p>
...
class IntHashMap {
	...
	/**
	 * <p>
	 * Innerclass that acts as a datastructure to create a new entry in the table.</p>
	 */
	...
	/**
	 * <p>
	 * Constructs a new, empty hashtable with the specified initial capacity and the specified load factor.</p>
	 *
	 * @param initialCapacity the initial capacity of the hashtable.
	...
	/**
	 * <p>
	 * Returns <code>true</code> if this HashMap maps one or more keys to this value.</p>
	 *
	 * <p>
	 * Note that this method is identical in functionality to contains (which predates the Map interface).</p>
	 *
