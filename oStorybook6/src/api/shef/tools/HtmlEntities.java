 ...
 * </p>
 *
 * @see <a href="http://hotwired.lycos.com/webmonkey/reference/special_characters/">ISO HtmlEntities</a>
 * @see </br><a href="http://www.w3.org/TR/REC-html32#latin1">HTML 3.2 Character HtmlEntities for ISO Latin-1</a>
 ...
 * @since 2.0
 * @version $Id: HtmlEntities.java,v 1.1 2007/11/20 13:49:17 cvsbob Exp $
 */
public class HtmlEntities {
	 ...
	 * </p>
	 */
	public static final HtmlEntities HTML_BASIC;
	 ...
	 * </p>
	 */
	public static final HtmlEntities HTML40_FULL;
	...
	static abstract class MapIntMap implements HtmlEntities.EntityMap {
	...
	// package scoped for testing
	EntityMap map = new HtmlEntities.LookupEntityMap();
			...
			if (ch == '&') {
				...
				if (entName.charAt(0) == '#') {
					...
					if (charAt1 == 'x' || charAt1 == 'X') {
						entValue = Integer.valueOf(entName.substring(2), 16);
					} else {
