...
public class TextEditPopupManager {
	...
	private TextEditPopupManager() {
		cut.putValue(Action.NAME, I18N.getMsg("shef." + ACTION_CUT));
		cut.putValue(Action.SMALL_ICON, IconUtil.getIconSmall(ICONS.K.EDIT_CUT));
		copy.putValue(Action.NAME, I18N.getMsg("shef." + ACTION_COPY));
		copy.putValue(Action.SMALL_ICON, IconUtil.getIconSmall(ICONS.K.EDIT_COPY));
		paste.putValue(Action.NAME, I18N.getMsg("shef." + ACTION_PASTE));
		paste.putValue(Action.SMALL_ICON, IconUtil.getIconSmall(ICONS.K.EDIT_PASTE));
		...
		popup.addSeparator();
		popup.add(selectAll);
		actions.put(ACTION_CUT, cut);
		actions.put(ACTION_COPY, copy);
		actions.put(ACTION_PASTE, paste);
		actions.put(SELECT_ALL, selectAll);
		actions.put(ACTION_UNDO, undo);
		actions.put(ACTION_REDO, redo);
	}
	...
	private class RedoAction extends AbstractAction {
		...
		public RedoAction() {
			...
			putValue(MNEMONIC_KEY, I18N.getMnem("shef.redo"));
		}
	...
	private class UndoAction extends AbstractAction {
		...
		public UndoAction() {
			super(I18N.getMsg("shef." + ACTION_UNDO), IconUtil.getIconSmall(ICONS.K.EDIT_UNDO));
			putValue(MNEMONIC_KEY, I18N.getMnem("shef." + ACTION_UNDO));
		}
