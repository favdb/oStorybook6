...
import api.jsoup.SerializationException;
import api.jsoup.helper.Validate;
import api.jsoup.internal.StringUtil;
import static api.jsoup.nodes.Entities.EscapeMode.base;
import static api.jsoup.nodes.Entities.EscapeMode.extended;
import api.jsoup.parser.CharacterReader;
...
public class Entities {
	...
	private static boolean canEncode(final CoreCharset charset, final char c, final CharsetEncoder fallback) {
		// t o d o  add more charset tests if impacted by Android's bad perf in canEncode
		switch (charset) {
			case ascii:
				return c < 0x80;
			case utf:
