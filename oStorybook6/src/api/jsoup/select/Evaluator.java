...
import api.jsoup.nodes.PseudoTextElement;
import api.jsoup.nodes.TextNode;
import api.jsoup.nodes.XmlDeclaration;
...
public abstract class Evaluator {
    ...
    public static final class AttributeStarting extends Evaluator {
        ...
        @Override
        public boolean matches(Element root, Element element) {
            List<api.jsoup.nodes.Attribute> values = element.attributes().asList();
            for (api.jsoup.nodes.Attribute attribute : values) {
        ...
        public boolean matches(Element root, Element element) {
            ...
            for (TextNode textNode : textNodes) {
                PseudoTextElement pel = new PseudoTextElement(
                    api.jsoup.parser.Tag.valueOf(element.tagName()), element.baseUri(), element.attributes());
