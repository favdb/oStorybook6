...
import api.infonode.gui.RotatableLabel;
import api.infonode.gui.TranslatingShape;
import api.infonode.gui.border.FocusBorder;
...
import api.infonode.gui.hover.hoverable.Hoverable;
import api.infonode.gui.icon.IconProvider;
import api.infonode.gui.layout.StackableLayout;
...
import api.infonode.tabbedpanel.*;
 ...
 *
 * <p>TitledTab implements the {@link api.infonode.gui.icon.IconProvider} interface and
...
public class TitledTab extends Tab implements IconProvider {
   ...
   * @see api.infonode.tabbedpanel.TabFactory
   */
      ...
      public void mouseClicked(MouseEvent e) {
        if (mouseListeners != null) {
          ...
          Object[] l = mouseListeners.toArray();
			for (Object l1 : l) {
				((MouseListener) l1).mouseClicked(event);
			}
        }
      }
