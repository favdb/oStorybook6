...
import api.infonode.gui.draggable.DraggableComponent;
import api.infonode.gui.draggable.DraggableComponentAdapter;
import api.infonode.gui.draggable.DraggableComponentEvent;

/**
 * Handles the drag and drop of a {@link api.infonode.docking.DockingWindow} triggered by mouse events on a
 * {@link JComponent}. {@link DockingWindowDragSource} handles drag abort with the right mouse button and
 * the key set in the {@link api.infonode.docking.properties.RootWindowProperties#ABORT_DRAG_KEY} property of the
 * {@link api.infonode.docking.RootWindow} which is the drop target.
 *
...
public class DockingWindowDragSource {
   ...
   *                        {@link api.infonode.docking.DockingWindow}
   ...
   *                        {@link api.infonode.docking.DockingWindow#startDrag(api.infonode.docking.RootWindow)}
