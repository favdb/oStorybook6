...
import api.infonode.docking.drop.DropFilterProperty;
import api.infonode.properties.propertymap.*;

/**
 * Properties and property values for {@link api.infonode.docking.drop.DropFilter}s
 * for all types of {@link api.infonode.docking.DockingWindow}s.
 *
...
public class DockingWindowDropFilterProperties extends PropertyMapContainer {
  ...
  /**
   * The {@link api.infonode.docking.drop.DropFilter} that is called when a
  ...
  /**
   * The {@link api.infonode.docking.drop.DropFilter} that is called when an
