 ...
 *
 * <p>
 * This drop type is performed on a {@link api.infonode.docking.RootWindow}
 * or a {@link api.infonode.docking.FloatingWindow} when they don't have any
 * top-level windows i.e. they appear empty. It is also perfomed on a
 * {@link api.infonode.docking.SplitWindow} when the drop will result in a
