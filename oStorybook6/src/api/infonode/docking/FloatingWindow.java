...
import api.infonode.docking.model.FloatingWindowItem;
 ...
 * a floating window in the {@link api.infonode.docking.properties.FloatingWindowProperties}, see
 * {@link FloatingWindow#getFloatingWindowProperties()}.
 * </p>
 *
 * <p>
 * A floating window is created by calling the
 * {@link api.infonode.docking.RootWindow#createFloatingWindow(Point, Dimension, DockingWindow)}
 * method or indirectly created by calling the
 * {@link api.infonode.docking.DockingWindow#undock(Point)} method.
 * </p>
 *
 * <p>
...
public class FloatingWindow extends DockingWindow {
   ...
   * Floating window inherits its component properties and shaped panel properties from the root
   * window's window area. It is possible to set specific component and shaped panel properties for
   * a floating window in the {@link api.infonode.docking.properties.FloatingWindowProperties}.
   * </p>
   *
