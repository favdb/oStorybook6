...
abstract public class DockingWindow extends BasePanel {
	...
	/**
	 * Splits this window in the given direction. If this window is a View which is contained in a TabWindow with a
	 * single tab, the TabWindow will splitted instead of this View.
	 *
	...
	/**
	 * Same as {@link #restore()}, but the {@link DockingWindowListener#windowRestoring(DockingWindow)} method of the
	 * window listeners will be called before restoring the window, giving them the possibility to abort the restore
	 * operation.
	 *
	...
	/**
	 * Restores this window to the location before it was minimized, maximized or closed. If the window can't be
	 * restored to the exact same location, a good approximation is performed. It's not guaranteed that the window is
	 * shown anywhere after this method has returned.
	 */
	@SuppressWarnings("unchecked")
	public void restore() {
		if (isMaximized()) {
...
//			if (getRootWindow() != null && lastFocused != null)
	...
	/**
	 * <p>
	 * Removes this window from it's window parent. If the window parent is a split window or a tab window with one
	 * child, it will be removed as well.</p>
	 *
	 * <p>
	 * The location of this window is saved and the window can be restored to that location using the {@link #restore()}
	 * method.</p>
	 *
	 * <p>
	 * This method will call the {@link DockingWindowListener#windowClosed(DockingWindow)} method of all the listeners
	...
	/**
	 * Same as {@link #close()}, but the {@link DockingWindowListener#windowClosing(DockingWindow)} method of the window
	 * listeners will be called before closing the window, giving them the possibility to abort the close operation.
	 *
	...
	/**
	 * <p>
	 * Undocks this window from it's window parent i.e. creates a {@link FloatingWindow} containing this window.</p>
	 *
	 * <p>
	 * The window can be docked again by calling {@link #dock()}.</p>
	 *
	 * <p>
	 * This method will call the {@link DockingWindowListener#windowUndocked(DockingWindow)} method of all the listeners
	 * of this window and all window ancestors. The listeners of child windows will not be notified, for example
	 * undocking a tab window containing views will not notify the listeners of views in that tab window.</p>
	 *
	 ...
	 *
	 * <p>
	 * If the window can't be docked to the exact same location, a good approximation is performed. It's not guaranteed
	 * that the window is shown anywhere after this method has returned.
	 * </p>
	 *
	 * <p>
	 * This method will call the {@link DockingWindowListener#windowDocked(DockingWindow)} method of all the listeners
	...
	/**
	 * Same as {@link #dock()}, but the {@link DockingWindowListener#windowDocking(DockingWindow)} method of the window
	 * listeners will be called before docking the window, giving them the possibility to abort the dock operation.
	 *
	...
	/**
	 * Sets the popup menu factory for this window. If it's not null a popup menu will be created and shown when the
	 ...
	 *
	 * @return the child window that last contained focus, null if no child window has contained focus or the child has
	 * been removed from this window
	 */
	...
	/**
	 * Same as {@link #maximize()}, but the {@link DockingWindowListener#windowMaximized(DockingWindow)} method of the
	 * window listeners will be called before maximizing the window, giving them the possibility to abort the maximize
	 * operation.
	 *
	...
	/**
	 * Minimizes this window. The window is minimized to the {@link WindowBar} in the preferred minimize direction, see
	 * {@link #setPreferredMinimizeDirection(api.infonode.util.Direction)} and {@link #getPreferredMinimizeDirection()}.
	 * If the {@link WindowBar} in that direction is not enabled, or the direction is null, thiw window is placed on the
	 * closest enabled {@link WindowBar}. If no suitable {@link WindowBar} was found or this window already is
	...
	/**
	 * Same as {@link #minimize()}, but the {@link DockingWindowListener#windowMinimizing(DockingWindow)} method of the
	 * window listeners will be called before minimizing the window, giving them the possibility to abort the minimize
	 * operation.
	 *
	...
	/**
	 * Same as {@link #minimize(Direction)}, but the {@link DockingWindowListener#windowMinimizing(DockingWindow)}
	 * method of the window listeners will be called before minimizing the window, giving them the possibility to abort
	...
	/**
	 * Makes this window visible. This causes the tabs of all {@link TabWindow} parents containing this window to be
	 * selected.
	 *
	 * @since IDW 1.1.0
	 */
