...
import api.infonode.docking.model.ViewReader;
import api.infonode.docking.model.ViewWriter;
import api.infonode.docking.properties.SplitWindowProperties;
import api.infonode.gui.ComponentUtil;
import api.infonode.gui.SimpleSplitPane;
import api.infonode.gui.SimpleSplitPaneListener;
...
public class SplitWindow extends DockingWindow {
	...
	/**
	 * Creates a split window with the given child windows.
	 *
	 * @param horizontal true if the split is horizontal
	...
	/**
	 * Gets the left/upper child window.
	 *
	...
	/**
	 * Gets the right/lower child window.
	 *
	...
	/**
	 * Gets the divider location as a fraction of this split window's size.
	 *
	...
	/**
	 * get the child window from the given insdex
	 *
	 * @param index
	 * @return
	 */
	...
	/**
	 * change the old RootWindow to a new one
	 *
	 * @param oldRoot
	 * @param newRoot
	 */
	...
	/**
	 * replace old DockingWindow by a new one
	 *
	 * @param oldWindow
	 * @param newWindow
	 */
	...
	/**
	 * remove the given DockingWindow
	 *
	 * @param window
	 */
	...
	/**
	 * restore the given DockingWindow
	 *
	 * @param window
	 */
	...
	/**
	 * get the index of the given DockingWindow
	 *
	 * @param window
	 * @param dir
	 * @return
